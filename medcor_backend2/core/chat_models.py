...
class ChatSession(models.Model):
    ...
    hospital = models.ForeignKey('tenants.Hospital', on_delete=models.CASCADE, related_name='chat_sessions')
...
class AnalysisReport(models.Model):
    ...
    hospital = models.ForeignKey('tenants.Hospital', on_delete=models.CASCADE, related_name='analysis_reports')
