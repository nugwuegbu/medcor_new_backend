...
class TestDataGenerator:
        ...
        doctors_data = [
            {
                ...
                'specialties': [specialties[0], specialties[4]],  # Cardiology, Neurology
            ...
            },
            {
                ...
                'specialties': [specialties[6], specialties[1]],  # Orthopedics, Dermatology
                ...
                for specialty in doc_data['specialties']:
                    ...
                    DoctorSpecialty.objects.get_or_create(
                        ...
                        defaults={
                            ...
                            'years_of_experience': doc_data['years_of_experience'],
                            'certification_date': date.today() - timedelta(days=365*5)
                        }
                    )
                
                print(f"  Created doctor: {doctor.get_full_name()} at {doc_data['hospital'].name}")
    ...
    def create_patients(self, hospitals):
        ...
        for patient_data in patients_data:
            ...
            if created:
                ...
                patient.save()
                print(f"  Created patient: {patient.get_full_name()} at {patient_data['hospital'].name}")
    ...
    def create_medical_records(self, patients, doctors):
        ...
        for record_data in records_data:
            ...
            if created:
                print(f"  Created medical record: {record.title} for {record_data['patient'].get_full_name()}")
