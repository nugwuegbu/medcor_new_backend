...
class SpecialtySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'certification_required', 'years_of_training',
            'is_active', 'created_at', 'updated_at',
            'total_doctors', 'statistics'
        ]
...
class DoctorSpecialtySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'doctor', 'doctor_name', 'specialty', 'specialty_details',
            'is_primary', 'certification_date', 'certification_number',
...
class SpecialtyStatisticsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'total_doctors', 'total_appointments', 'average_rating',
            'appointment_requests_last_month', 'average_wait_days',
            'last_updated'
        ]
...
class BulkSpecialtyAssignSerializer(serializers.Serializer):
    ...
    def validate_doctor_ids(self, value):
        ...
        if len(doctors) != len(value):
            ...
            raise serializers.ValidationError(
                f"Invalid doctor IDs: {invalid_ids}"
            )
        return value
