...
class HospitalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Hospital
        fields = [
            'id', 'name', 'slug', 'hospital_type', 'description',
            'phone_number', 'email', 'website',
            'address_line1', 'address_line2', 'city', 'state', 'country', 'postal_code',
            'latitude', 'longitude', 'full_address', 'location_coordinates',
            'bed_count', 'emergency_services', 'trauma_center_level',
            'operating_hours', 'services', 'accreditations', 'license_number',
            'is_active', 'is_verified', 'created_at', 'updated_at',
            'is_emergency_capable', 'is_trauma_center'
        ]
...
class HospitalCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Hospital
        fields = [
            'name', 'hospital_type', 'description',
            'phone_number', 'email', 'website',
            'address_line1', 'address_line2', 'city', 'state', 'country', 'postal_code',
            'latitude', 'longitude',
            'bed_count', 'emergency_services', 'trauma_center_level',
...
class HospitalListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Hospital
        fields = [
            'id', 'name', 'slug', 'hospital_type', 'city', 'state',
            'full_address', 'emergency_services', 'is_active', 'is_verified',
