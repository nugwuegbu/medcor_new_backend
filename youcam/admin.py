...
class YouCamAnalysisAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'id', 'analysis_type', 'status', 'user', 'image_preview',
        'retry_count', 'created_at', 'completed_at'
    ]
    list_filter = [
        'analysis_type', 'status', 'created_at', 'completed_at'
    ]
    search_fields = ['id', 'user__email', 'analysis_type']
    readonly_fields = [
        'id', 'celery_task_id', 'raw_response', 'analysis_results',
        'issues_detected', 'recommendations', 'created_at', 'updated_at',
        'completed_at', 'image_preview'
    ]
    fieldsets = (
        ('Basic Information', {
...
class AnalysisHistoryAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'id', 'user', 'analysis_type', 'analysis_status',
        'feedback_rating', 'viewed_at'
    ]
    list_filter = [
        'analysis__analysis_type', 'analysis__status',
        'feedback_rating', 'viewed_at'
    ]
