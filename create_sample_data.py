...
class SampleDataGenerator:
    ...
    def generate_all(self):
        ...
        print(
            f"  ✓ Created {len(self.data['doctor_specialties'])} doctor-specialty associations"
        )
    ...
    def print_summary(self):
        ...
        for admin in self.data["admins"]:
            print(
                f"    • {admin['email']} / {admin['password']} ({admin['hospital_name']})"
            )

        print("\n  Doctors:")
        for doctor in self.data["doctors"]:
            print(
                f"    • {doctor['email']} / {doctor['password']} ({doctor['primary_specialty_name']})"
            )
