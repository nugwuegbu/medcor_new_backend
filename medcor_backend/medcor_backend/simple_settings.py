"""
Simplified Django settings for direct admin access (without django-tenants)
"""
...
# Security settings
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-direct-admin-key')
DEBUG = True
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
...
# Application definition (WITHOUT django-tenants)
INSTALLED_APPS = [
    ...
    'ckeditor',
    'django_filters',
    'simple_tenant',  # Simplified tenant models
    'core',
    # 'treatment',  # Temporarily disabled due to tenant dependency
]
...
# Database (using standard PostgreSQL, not django-tenants)
DATABASES = {
    'default': {
