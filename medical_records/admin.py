...
class MedicalRecordAdmin(admin.ModelAdmin):
    ...
    list_display = ['id', 'patient', 'record_type', 'title', 'created_by', 'hospital', 'created_at']
    list_filter = ['record_type', 'is_confidential', 'access_restricted', 'hospital', 'created_at']
    ...
    fieldsets = (
        ...
        ('Patient & Doctor', {
            'fields': ('patient', 'created_by', 'hospital')
        }),
        ('Medical Details', {
            'fields': ('diagnosis', 'symptoms', 'vital_signs', 'lab_results')
        }),
        ('Related Information', {
            'fields': ('appointment', 'attachments')
        }),
        ('Privacy & Security', {
            'fields': ('is_confidential', 'access_restricted')
        }),
        ('Metadata', {
...
class MedicalDocumentAdmin(admin.ModelAdmin):
    ...
    list_display = ['id', 'medical_record', 'document_type', 'title', 'hospital', 'created_at']
    ...
    fieldsets = (
        ('Document Information', {
            'fields': ('id', 'medical_record', 'document_type', 'title', 'description')
        }),
        ('File Details', {
            'fields': ('file', 'file_size', 'file_type')
        }),
        ('Context', {
            'fields': ('hospital', 'uploaded_by')
        }),
        ('Timestamps', {
