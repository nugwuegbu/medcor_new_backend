...
class MedicalDocumentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'hospital', 'medical_record', 'document_type', 'title',
            'description', 'file', 'file_size', 'file_type', 'uploaded_by',
            'uploaded_by_name', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at', 'uploaded_by_name', 'file_size', 'file_type']
...
class MedicalRecordSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MedicalRecord
        fields = [
            'id', 'hospital', 'patient', 'patient_name', 'created_by',
            'created_by_name', 'record_type', 'title', 'description',
            'diagnosis', 'symptoms', 'vital_signs', 'lab_results',
            'attachments', 'appointment', 'is_confidential',
            'access_restricted', 'created_at', 'updated_at',
            'metadata', 'documents'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at', 'patient_name', 'created_by_name']
...
class MedicalRecordListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MedicalRecord
        fields = [
            'id', 'patient_name', 'created_by_name', 'record_type',
            'title', 'created_at', 'is_confidential', 'document_count'
        ]
...
class CreateMedicalRecordSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MedicalRecord
        fields = [
            'hospital', 'patient', 'created_by', 'record_type', 'title',
            'description', 'diagnosis', 'symptoms', 'vital_signs',
            'lab_results', 'attachments', 'appointment', 'is_confidential',
            'access_restricted', 'metadata', 'documents'
        ]
