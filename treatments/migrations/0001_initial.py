...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Name of the hospital or clinic",
                        max_length=200,
                    ),
                ),
                (
        ...
        migrations.AddIndex(
            model_name="treatment",
            index=models.Index(
                fields=["hospital_name", "status"], name="treatments_hospita_1937f5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="treatment",
            index=models.Index(
                fields=["hospital_name", "start_date"],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["hospital_name", "treatment"],
        ...
        migrations.AddIndex(
            model_name="prescription",
            index=models.Index(
                fields=["hospital_name", "is_active"],
