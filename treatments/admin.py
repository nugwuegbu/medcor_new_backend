...
class TreatmentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Patient & Doctor", {"fields": ("patient", "prescribed_by", "hospital")}),
        (
            "Treatment Plan",
            {"fields": ("start_date", "end_date", "status", "instructions")},
        ),
        ("Dosage & Frequency", {"fields": ("frequency", "dosage", "duration")}),
        ("Safety Information", {"fields": ("side_effects", "warnings")}),
        ("Related Information", {"fields": ("appointment", "medical_record")}),
        (
            "Timestamps",
...
class PrescriptionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Instructions", {"fields": ("instructions", "take_with_food")}),
        ("Timing", {"fields": ("start_date", "end_date", "duration_days")}),
        (
            "Quantity & Refills",
            {
                "fields": (
        ...
        ("Context", {"fields": ("hospital", "pharmacy_name", "pharmacy_phone")}),
        ("Status", {"fields": ("is_active", "is_dispensed", "dispensed_date")}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
