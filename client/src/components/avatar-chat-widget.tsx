...
export default function AvatarChatWidget({ isOpen, onClose }: AvatarChatWidgetProps) {
  ...
  if (showDoctorList && !showChatInterface) {
    return (
      <div className="chat-widget-container fixed bottom-4 w-[380px] h-[600px] rounded-2xl shadow-2xl overflow-hidden flex flex-col z-50 relative" style={{ right: '16px', left: 'auto' }}>
        {/* Video Background */}
        <video
          autoPlay
          muted
  ...
  return (
    <div className="chat-widget-container fixed bottom-4 w-[380px] h-[600px] rounded-2xl shadow-2xl overflow-hidden flex flex-col z-50 animate-glow-border relative" style={{ right: '16px', left: 'auto' }}>
      {/* Video Background */}
      <video
        autoPlay
        muted
