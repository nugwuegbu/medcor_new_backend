...
class SpecialtyAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Requirements", {"fields": ("certification_required", "years_of_training")}),
...
class DoctorSpecialtyAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Assignment", {"fields": ("doctor", "specialty", "is_primary")}),
        (
...
class SpecialtyStatisticsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Update Info", {"fields": ("last_updated",)}),
    )
    ...
    def update_statistics(self, request, queryset):
        ...
        self.message_user(
            request, f"Updated statistics for {queryset.count()} specialties"
        )
