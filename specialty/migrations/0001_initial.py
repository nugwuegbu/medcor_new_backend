    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["name"],
                "indexes": [
                    models.Index(fields=["code"], name="specialty_s_code_4cc8ec_idx"),
                    models.Index(
                        fields=["is_active"], name="specialty_s_is_acti_f82e29_idx"
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="specialty_d_doctor__7e142a_idx",
                    ),
                    models.Index(
                        fields=["specialty"], name="specialty_d_special_079429_idx"
                    ),
                ],
