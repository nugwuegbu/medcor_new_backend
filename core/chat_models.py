...
class FaceRecognition(models.Model):
    ...
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, related_name="face_recognition"
    )
...
class AvatarRecording(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    session = models.ForeignKey(
        ChatSession, on_delete=models.CASCADE, related_name="recordings"
    )
...
class AnalysisReport(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="analysis_reports"
    )
    hospital = models.ForeignKey(
        "tenants.Hospital",
        on_delete=models.CASCADE,
