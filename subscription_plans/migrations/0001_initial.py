    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['slug'], name='subscriptio_slug_c8f940_idx'), models.Index(fields=['is_active'], name='subscriptio_is_acti_4d4352_idx')],
            },
        ),
        migrations.CreateModel(
            name='Subscription',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('hospital_name', models.CharField(help_text='Name of the hospital or clinic', max_length=200)),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['hospital_name'], name='subscriptio_hospita_4f671f_idx'), models.Index(fields=['status'], name='subscriptio_status_572d44_idx'), models.Index(fields=['end_date'], name='subscriptio_end_dat_763002_idx')],
            },
        ),
    ]
